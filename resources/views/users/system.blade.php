...
@csrf 
    <div class="form-group">
        ...
        <div class="checkbox">
        	<input class="styled" type="checkbox"  value="{{ $setting->is_saturday }}" name="is_saturday" {{$setting->is_saturday ? 'checked' : ''}}> 
    ...
    <div class="form-group">
        ...
        <div class="checkbox checkbox-inline">
            <input class="for_small" type="checkbox"  value="{{ $setting->is_s_muslim }}" name="is_s_muslim" {{$setting->is_s_muslim ? 'checked' : ''}}> 
            <label>อาหารมุสลิม</label>
        </div>
        <div class="checkbox checkbox-inline">
            <input class="for_small" type="checkbox"  value="{{ $setting->is_s_vege }}" name="is_s_vege" {{$setting->is_s_vege ? 'checked' : ''}}> 
            <label>อาหารมังสวิรัติ</label>
        </div>
        <div class="checkbox checkbox-inline">
            <input class="for_small" type="checkbox"  value="{{ $setting->is_s_vegan }}" name="is_s_vegan" {{$setting->is_s_vegan ? 'checked' : ''}}> 
            <label>อาหารเจ</label>
        </div>
        <!-- small kids carbs -->
        <div>
        ...
        <div class="checkbox checkbox-inline">
            <input class="for_small" type="checkbox"  value="{{ $setting->is_s_milk }}" name="is_s_milk" {{$setting->is_s_milk ? 'checked' : ''}}> 
            <label>นมวัว</label>
        </div>
        <div class="checkbox checkbox-inline">
            <input class="for_small" type="checkbox"  value="{{ $setting->is_s_breastmilk }}" name="is_s_breastmilk" {{$setting->is_s_breastmilk ? 'checked' : ''}}> 
            <label>นมแม่</label>
        </div>
        <div class="checkbox checkbox-inline">
            <input class="for_small" type="checkbox"  value="{{ $setting->is_s_egg }}" name="is_s_egg" {{$setting->is_s_egg ? 'checked' : ''}}> 
            <label>ไข่ไก่</label>
        </div>
        <div class="checkbox checkbox-inline">
            <input class="for_small" type="checkbox"  value="{{ $setting->is_s_wheat }}" name="is_s_wheat" {{$setting->is_s_wheat ? 'checked' : ''}}> 
        ...
        <div class="checkbox checkbox-inline">
            <input class="for_small" type="checkbox"  value="{{ $setting->is_s_shrimp }}" name="is_s_shrimp" {{$setting->is_s_shrimp ? 'checked' : ''}}> 
            <label>กุ้ง</label>
        </div>
        <div class="checkbox checkbox-inline">
            <input class="for_small" type="checkbox"  value="{{ $setting->is_s_shell }}" name="is_s_shell" {{$setting->is_s_shell ? 'checked' : ''}}> 
            <label>หอย</label>
        </div>
        <div class="checkbox checkbox-inline">
            <input class="for_small" type="checkbox"  value="{{ $setting->is_s_crab }}" name="is_s_crab" {{$setting->is_s_crab ? 'checked' : ''}}> 
            <label>ปู</label>
        </div>
        <div class="checkbox checkbox-inline">
            <input class="for_small" type="checkbox"  value="{{ $setting->is_s_fish }}" name="is_s_fish" {{$setting->is_s_fish ? 'checked' : ''}}> 
            <label>ปลา</label>
        </div>
        <!-- small kids ิ beans-->
        <div>
        ...
        <div class="checkbox checkbox-inline">
            <input class="for_small" type="checkbox"  value="{{ $setting->is_s_peanut }}" name="is_s_peanut" {{$setting->is_s_peanut ? 'checked' : ''}}> 
            <label>ถั่วลิสง</label>
        </div>
        <div class="checkbox checkbox-inline">
            <input class="for_small" type="checkbox"  value="{{ $setting->is_s_soybean }}" name="is_s_soybean" {{$setting->is_s_soybean ? 'checked' : ''}}> 
